...
//			levels = 1;
		...
		do
		{
			...
			{
				error( "Failed to create texture: width=%i, height=%i, levels=%i, usage=0x%X, format=%s, pool=0x%X.", width()/*// M.Sungatullin [25.12.2016]:*/, height, levels, usage, toString(originalFormat), pool );
				return;
			}
